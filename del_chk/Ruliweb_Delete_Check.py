...
cursor.execute(query, ("RULIWEB", "1", today_3_ago, today))
...
def crawling():
    for row in select_result:
        ...
        try:
            ...
            contents = soup.select_one("#board_read > div > div.board_main > \
            div.board_main_top > div.user_view > div.row.user_view_target")
            if not contents:
