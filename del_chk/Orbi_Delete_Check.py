...
cursor.execute(query, ("ORBI", "1", today_3_ago, today))
    ...
    for row in select_result:
        ...
        try:
            ...
            contents = soup.select_one(
                "body > div.global-body > div > div > div.content-body > \
                united-read > div:nth-child(1) > div.title-wrap > h1")
            if not contents or contents.get_text() == '회원에 의해 삭제된 글입니다.':
